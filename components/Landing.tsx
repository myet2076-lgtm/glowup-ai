...
const Landing: React.FC<Props> = ({ onQuiz, onCelebrity, onInspiration, onFaceAnalysis, onHairLab }) => {
  const features: FeatureCard[] = [
    ...
    { title: 'Celebrity Twin', label: 'Find Your Match', onClick: onCelebrity, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBRROfVWUnzKb0SxBnyUwKQ7nukeV-pnGVR6K9DwF9zFPGG7exao6OtcmhC23-JOfX9tVGVMYYh6x_deTT9y0SfIER16mpvgepyXXLKo-eHxCeqU5rpMdG8LQkFJIQP3iw1IecmKwCOjdHpWdVl64jRjLZ2cnRkMIabHaDEf5BOG1ZzGlW_ujCpk2HW0yiJnZwtCXQ_-qI9A49eZujnhFwzR90JB6GyU61pEsV66_sgmxmyomGmk4TwpTxu3Qe4lFL_r2swQnaOcyfg', imageAlt: 'Celebrity twin match portrait' },
