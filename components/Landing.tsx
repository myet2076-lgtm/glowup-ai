...
const Landing: React.FC<Props> = ({ onQuiz, onCelebrity, onInspiration, onFaceAnalysis, onHairLab }) => {
  const features: FeatureCard[] = [
    ...
    { title: 'Hair Lab', label: 'Try New Styles', onClick: onHairLab, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAv4n0npcywEleQ-co_rNkgg4AB7ia9aJAUEwiCF2G2KPQF1Q_MhL2PtgaYmXmVpcqn93DnV2y_BHHDLheemOa3rRgEsOgAkq5vBOugzX6qBPZQa5qV5R1xIAnOBhoaHgbzvGPohhaljosIXB0ABRUvMkeMLCQF9JVh2XMiXYJzVDmhMtGVZAegv7t6_zimLYBa9FoJmPNPme5YUbxA3XqZhXBjU_j913KQPSIJgDBicyu4kpW504-ctWRqFswXzMHUtq8UdcSijXtN', imageAlt: 'Hair styling portrait' },
