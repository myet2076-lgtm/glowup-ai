...
For privacy inquiries, email us at **myet2076@gmail.com**
`;
...
Questions about these terms? Email us at **myet2076@gmail.com**
`;
...
**Have more questions?** Email us at **myet2076@gmail.com**
`;
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-16 w-full max-w-screen-2xl mx-auto py-24 px-8">
          ...
          <div className="grid grid-cols-2 gap-12 w-full md:w-auto">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li><a href="mailto:myet2076@gmail.com" className="text-neutral-400 hover:text-primary text-xs transition-all tracking-wider cursor-pointer no-underline">Contact</a></li>
